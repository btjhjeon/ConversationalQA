...
for story in story_dic:
    ...
    if(FLAGS.use_testset):
        ...
        testS, testQ, testA, testA_org = panda_utils.vectorize_data(test, word_idx, sent2vec_model, sentence_size, memory_size, ans_sentence_size)
    else:
    ...
    with tf.Graph().as_default() as graph:
        with tf.Session() as sess:
            ...
            if FLAGS.use_testset:
                ...
                # print('test_preds : ', np.array(test_preds).shape)
                # print(test_preds)
